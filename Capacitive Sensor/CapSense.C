...
void	FPPA0 (void)
{
	...
	$ T16M 	ILRC, /4, BIT12;	// Use ILRC/64 to count timer, set INTRQ.T16 = 1 every 2^15 times
	...
	WORD baseline_5 = 0;
	WORD baseline_6 = 0;
	WORD margin = 0x30; // margin of difference = 16 counts
